...
import main.java.com.hh1305.TailProgram.v3.Handler.FileHandlerVersion1;

class TailProgramTestV1 {
	...
	FileHandler v1_fileHandler = new FileHandlerVersion1(input);
	...
	@Test
	void test() {
		v1_fileHandler.handleFile();
		assertEquals(expected, v1_fileHandler.outputFile().getMessage());
	}

	@Test
	void test2() {
		v1_fileHandler.setN(0);
		v1_fileHandler.handleFile();
		assertEquals("", v1_fileHandler.outputFile().getMessage());
	}
